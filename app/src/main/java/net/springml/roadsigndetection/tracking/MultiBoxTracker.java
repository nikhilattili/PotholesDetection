...
package net.springml.roadsigndetection.tracking;
...
import net.springml.roadsigndetection.Classifier.Recognition;
import net.springml.roadsigndetection.env.ImageUtils;
import net.springml.roadsigndetection.env.Logger;
import net.springml.roadsigndetection.env.BorderedText;
...
public class MultiBoxTracker {
  ...
  private static final int TEXT_SIZE_DIP = 22;
