...
package net.springml.potholesdetection.tracking;
...
import net.springml.potholesdetection.Classifier.Recognition;
import net.springml.potholesdetection.env.ImageUtils;
import net.springml.potholesdetection.env.Logger;
import net.springml.potholesdetection.env.BorderedText;
...
public class MultiBoxTracker {
  ...
  private static final float MIN_CORRELATION = 0.4f;
